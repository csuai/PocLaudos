...
{
    [DbContext(typeof(Db))]
    [Migration("20240408160717_ValorListaDetalhadaTb")]
    partial class ValorListaDetalhadaTb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PocLaudos.Model.CampoListaDetalhada", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PocLaudos.Model.ItemLista", b =>
                {
                    ...
                    b.Property<Guid?>("CampoListaDetalhadaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CampoListaDetalhadaId");
            ...
            modelBuilder.Entity("PocLaudos.Model.ValorListaDetalhada", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PocLaudos.Model.ItemLista", b =>
                {
                    b.HasOne("PocLaudos.Model.CampoListaDetalhada", null)
                        .WithMany("Itens")
                        .HasForeignKey("CampoListaDetalhadaId")
                        .OnDelete(DeleteBehavior.Restrict);
